...
import com.abhi.flickr.repository.datasource.LocalDataSource;
import com.abhi.flickr.repository.datasource.RemoteDataSource;
...
public class FlikrRepositoryImpl implements FlikrRepository {
    ...
    private FlikrRepositoryImpl(RemoteDataSource mRemoteDataSource, final LocalDataSource mLocalDataSource, FlickrMapper mapper) {
